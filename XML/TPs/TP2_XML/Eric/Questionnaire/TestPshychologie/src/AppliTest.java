...
public class AppliTest {
	...
	public void setQuestionsReponses(){
		...
		for (int i = 1 ; i<= nbQuestions ; i ++ ) {
			...
			qr.setIdQuestion(i);
			qr.setIntituleQuestions(libQuestion);
			for (Integer j : this.interpretationCaracteres.keySet()){
				...
				qr.put(j, libCaractereAssocie);
			}
			this.questionsEtChoix.add(qr);
		}
	}
	...
	public static void main(String[] args) throws Exception {
		...
		//*************************************CREATION DU QUESTIONNAIRE EN VERSION XML *******************************************//
		  ...
		  int i = 0 ;
		  //on parcours notre liste de questions
		  for (QuestionReponse qr : monGenerateurDeQuestions.questionsEtChoix) {
