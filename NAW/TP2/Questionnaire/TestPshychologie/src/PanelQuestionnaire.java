...
public class PanelQuestionnaire{
	...
	public void lancerQuestionnaire(int choix) throws Exception{
		  ...
		  // Pour chaque question du questionnaire choisis, j'insère le Panel qui lui correspond dans le JPanel.
